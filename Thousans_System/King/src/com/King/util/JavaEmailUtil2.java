 ...
 *
 */
public class JavaEmailUtil2{
	public static void main(String[] args) {
		new JavaEmailUtil2().sendAuthCodeEmail("heibas@126.com");
	}
	 /**
     * 发送验证码
     * @param email
    ...
    public String sendAuthCodeEmail(String email) {
        ...
        try {
            ...
            mail.setHostName("163.smtp.com");
            /*不设置发送的消息有可能是乱码*/
            mail.setCharset("UTF-8");
            /*IMAP/SMTP服务的密码*/
            mail.setAuthentication("Z2568698586@163", "VZKVCZGAFMGWSEUB");
            /*发送邮件的邮箱和发件人*/
            mail.setFrom("Z2568698586@163", "z");
            /*使用安全链接*/
